  ...
  if (!hasActivity) {
    return (
      <motion.div
        ...
        className="rounded-3xl bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-white/40 dark:border-slate-700 shadow-xl min-h-[560px] flex flex-col items-center justify-center p-6"
      >
